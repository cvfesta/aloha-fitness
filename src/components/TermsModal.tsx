...
/**
 * Governing-law jurisdiction. The address comes from site.location.address;
 * the law jurisdiction is a separate decision (a business can operate in one
 * state and choose another's law). If the business reincorporates elsewhere,
...
I hereby release and forever discharge Aloha Fitness, located at ${site.location.address}, their affiliates, managers, members, agents, attorneys, staff, volunteers, heirs, representatives, predecessors, successors and assigns (collectively "Releasees"), from any physical or psychological injury that I may suffer as a direct result of my participation in the aforementioned Activity.
...
I agree that this Release shall be governed for all purposes by ${GOVERNING_LAW} law, without regard to any conflict of law principles. This Release supersedes any and all previous oral or written promises or other agreements.
